        ...
        <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20 lg:items-center">
          ...
          <div>
            <Reveal>
              ...
              <p className="mt-6 text-sm md:text-base leading-relaxed text-muted-custom font-light max-w-lg">
                {OVERVIEW}
              </p>
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div>
      <p className="font-mono-ui text-[10px] uppercase tracking-wider text-faint-custom">
        {label}
      </p>
