      ...
      <div className="mx-auto max-w-6xl">
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[28px] border border-border bg-gradient-to-br from-[var(--color-surface-raised)]/70 to-[var(--color-surface)] p-8 sm:p-14 backdrop-blur-sm shadow-2xl">
            ...
            <div className="absolute left-6 top-5 font-mono-ui text-[8px] tracking-wider text-text-faint select-none">
              SYS // BUILDATHON_SPEC_v2.0
            </div>
            <div className="absolute right-6 top-5 font-mono-ui text-[8px] tracking-wider text-text-faint select-none">
              GRID // STAGE_C
            </div>
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-14">
              <div>
                ...
                <p className="mt-6 max-w-xl text-sm md:text-base leading-relaxed text-text-muted font-light">
                ...
                <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {BUILDATHON_THEME.capabilities.map((c) => (
                    <div
                      key={c}
                      className="rounded-2xl border border-border bg-base/50 px-5 py-4 text-xs font-semibold font-mono-ui text-text-muted hover:border-signal/30 hover:text-text transition-colors duration-300 flex items-center gap-3"
                    >
